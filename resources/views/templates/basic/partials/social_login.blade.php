...
@if (@gs('socialite_credentials')->linkedin->status || @gs('socialite_credentials')->facebook->status == App\Constants\Status::ENABLE || @gs('socialite_credentials')->google->status == App\Constants\Status::ENABLE)
    <p class="text-center">
        @lang("$text with")
    </p>
    <div class="social-link-wrapper">
        @if (@gs('socialite_credentials')->google->status == App\Constants\Status::ENABLE)
    ...
    @endif
        @if (@gs('socialite_credentials')->facebook->status == App\Constants\Status::ENABLE)
        ...
        @endif
        @if (@gs('socialite_credentials')->linkedin->status == App\Constants\Status::ENABLE)
            <div class="continue-facebook flex-grow-1">
