                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-7 col-md-7">
                            <div class="form-group ">
                                ...
                                <select class="form-control form-select select2 form--control h-50 w-100" name="category_id" id="category" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-select select2 form--control h-50 w-100" name="subcategory_id" id="subcategory">
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-text bg--base text--white">{{ gs('cur_text') }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
