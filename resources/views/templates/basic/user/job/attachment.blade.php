                ...
                <ul class="latest-posts m-0">
                    <li class="flex-wrap">
                        <div class="post-thumb">
                            <img src="{{ getImage(getFilePath('userProfile') . '/' . @$prove->user->image, avatar: true) }}" alt="@lang('User')">
                        </div>
                    ...
                    <li>
                        <div class="d-flex flex-wrap w-100" style="gap:7px">
                            @if ($prove->status == App\Constants\Status::JOB_PROVE_PENDING)
                                ...
                                <button href="javascript:void(0)" class="btn btn--danger btn--sm confirmationBtn" data-action="{{ route('user.job.reject', encrypt($prove->id)) }}" data-question="@lang('Are you sure to rejected this job?')">
