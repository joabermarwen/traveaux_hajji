...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.jobs.index') }}" title="Total Jobs" icon="lar la-flag"
                value="{{ $job['total_job'] }}" bg="primary" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.jobs.pending') }}" title="Pending jobs"
                icon="fas fa-spinner" value="{{ $job['pending_job'] }}" bg="warning" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.jobs.complete') }}" title="Complete jobs"
                icon="las la-check-circle" value="{{ $job['complete_job'] }}" bg="green" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.jobs.rejected') }}" title="Rejected jobs"
                icon="las la-times-circle" value="{{ $job['cancel_job'] }}" bg="16" outline="true" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.index') }}" icon_style="false"
                icon="fas fa-money-check-alt" title="Total Jobs Amount"
                value="{{ showAmount($job['total_job_amount']) }}" color="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.pending') }}" icon_style="false" icon="las la-spinner"
                title="Pending Jobs Amount" value="{{ showAmount($job['pending_job_amount']) }}"
                color="warning" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.complete') }}" icon_style="false"
                icon="las la-check-circle" title="Completed Jobs Amount"
                value="{{ showAmount($job['complete_job_amount']) }}" color="green" />

        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.jobs.rejected') }}" icon_style="false" icon="las la-ban"
                title="Rejected Jobs Amount" value="{{ showAmount($job['cancel_job_amount']) }}"
                color="red" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
