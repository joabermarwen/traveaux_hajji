...
class FileManager
{
    ...
    */
    ...
    {
        // Assuming FileInfo contains the paths for files
        $fileInfo = new FileInfo();  // Initialize the FileInfo class
        $logoPath = $fileInfo->fileInfo()['logoIcon'];  // Get the 'logo' path from fileInfo() method

        return (object)$logoPath;
    }
